...
import { User, Shield, Phone, Mail, MapPin, Heart, Stethoscope, AlertTriangle, Droplet, UserCheck, CreditCard } from 'lucide-react';
    ...
    <div className="space-y-6 pb-12 max-w-4xl mx-auto">
      <div>
        <h1 className="text-2xl font-bold text-slate-900 dark:text-white flex items-center gap-2">
          ...
          Patient Demographic Profile & Health Identifiers
        </h1>
        <p className="text-xs text-slate-500">
          Personal identification, emergency contact records, primary doctor affiliation, allergies & health insurance details
        </p>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-sm space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5 border-b border-slate-100 dark:border-slate-800 pb-6">
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-slate-500">
              MRN #{activePatient.mrn} • Age: {activePatient.age} yrs • Gender: {activePatient.gender} • DOB: March 14, 1981
            </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-xs">
          ...
          <div className="p-5 bg-slate-50 dark:bg-slate-800/80 rounded-2xl border border-slate-200/80 dark:border-slate-700/80 space-y-3">
            ...
            <div className="space-y-2">
              <p className="font-semibold text-slate-800 dark:text-slate-100 flex items-center gap-2">
                <Phone className="w-4 h-4 text-emerald-600 shrink-0" /> +1 (555) 234-5678
              </p>
              <p className="font-semibold text-slate-800 dark:text-slate-100 flex items-center gap-2">
                <Mail className="w-4 h-4 text-emerald-600 shrink-0" /> {activePatient.name.toLowerCase().replace(' ', '.')}@healthnet.org
              </p>
              <p className="font-semibold text-slate-800 dark:text-slate-100 flex items-center gap-2">
                <MapPin className="w-4 h-4 text-emerald-600 shrink-0" /> 742 Evergreen Terrace, Springfield, IL 62704
              </p>
            </div>
          </div>
          ...
          <div className="p-5 bg-slate-50 dark:bg-slate-800/80 rounded-2xl border border-slate-200/80 dark:border-slate-700/80 space-y-3">
            ...
            <div className="space-y-1">
              <p className="font-extrabold text-slate-900 dark:text-white text-sm">Robert Vance</p>
              <p className="text-slate-500 font-medium">Relationship: Spouse</p>
              <p className="font-bold text-emerald-700 dark:text-emerald-300 flex items-center gap-1.5 pt-1">
                <Phone className="w-3.5 h-3.5 text-emerald-600" /> +1 (555) 876-5432
              </p>
            </div>
          </div>
        ...
        <div className="p-5 bg-blue-50/70 dark:bg-slate-800 rounded-2xl border border-blue-200 dark:border-slate-700 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              <p className="font-extrabold text-sm text-slate-900 dark:text-white">Blue Cross Health Platinum Plan</p>
              <p className="text-xs text-slate-600 dark:text-slate-300 font-medium">Policy #: BC-293810293 • Group #: 8840219</p>
